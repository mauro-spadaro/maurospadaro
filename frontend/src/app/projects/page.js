...
const PROJECTS = [
  {
    ...
    what: "As companies grow, approval processes get complex fast. The Workflow Designer gives finance and ops teams full flexibility to define, customise and manage approval workflows as they best think.",
  ...
  },
  {
    ...
    did: "Designed the first version in Figma, built it in Webflow, then rebuilt it entirely from scratch using Next.js 14, Tailwind CSS and a markdown-based CMS. Handled everything solo: design, frontend development, and SEO.",
    outcomes: [
      "Fully custom Next.js build with no CMS dependency",
      "Static site with automated deploys on every push",
